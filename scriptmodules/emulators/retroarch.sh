...
rp_module_repo="git https://github.com/libretro/RetroArch.git v1.9.5"
...
function build_retroarch() {
    ...
    isPlatform "x11" || isPlatform "vk" && params+=(--enable-vulkan --disable-wayland)
    ! isPlatform "vk" && params+=(--disable-vulkan --disable-wayland)
